...
#port number : 5002 5003
external_port_1 : telnet 5002
...
mudlib directory : /home/zoilder/develmud/mudlib

# absolute pathname of driver/config dir
binary directory : /home/zoilder/develmud/driver/fluffos/bin
...
# Originalmente era 1200 (20 minutos) -- Dunkelheit 30-10-2008
# En RL2 usamos 7200 (2 horas)
...
# Originalmente era 600. En RL2 usamos 1800 (30 min)-- Dunkelheit 30-10-2008
#   Actualmente el driver ya no utiliza esta funcion ya que el swapping
#   queda relegado al SO -- Dunkelheit 04-11-2008
time to swap : 1800

# How many seconds until an object is reset again.
# En RL2 usamos 1800 (30 minutos)
time to reset : 1800
...
default fail message : Perdon?

# default message when error() occurs (optional)
default error message : Se ha producido un error. Por favor, utiliza el comando 'error' para notificarlo.

# external commands
external_cmd_1: /usr/bin/php5
external_cmd_2: /usr/bin/mail
