...
Design & rationale: docs/driver/ffi-plan.md. Key rule: a C char*/data
...
def emit_lpc(funcs, libpath, string_convenience):
    lines = [
        ...
        "// explicitly). See docs/driver/ffi-plan.md.",
        "#include <ffi.h>",
        "",
...
def emit_structs(structs):
    lines = [
        ...
        "// arrays and symbolic field offsets. See docs/driver/ffi-plan.md.",
