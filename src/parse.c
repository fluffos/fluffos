 ...
 */
int
parse(cmd, ob_or_array, pattern, stack_args, num_arg)
    ...
    int 		num_arg;	/* Number of args on stack */
{
    ...
    */
	...
	if (EQ(patvec->item[pix].u.string, "%s"))
	{
		...
		/* 
		    We found something mathing the pattern after %s.
		    First
 ...
 */
struct svalue *
sub_parse(obvec, patvec, pix_in, wvec, cix_in, fail, sp)
    struct vector *obvec;
 ...
 */
struct svalue *
one_parse(obvec, pat, wvec, cix_in, fail, prep_param)
    struct vector *obvec;
    char *pat;
    struct vector *wvec;
    int *cix_in;
 ...
 */
struct svalue *
number_parse(obvec, wvec, cix_in, fail)
    struct vector *obvec;
    struct vector *wvec;
    int *cix_in;
    int *fail;
 ...
 */
struct svalue *
item_parse(obvec, wvec, cix_in, fail)
    struct vector *obvec;
    struct vector *wvec;
    int *cix_in;
    int *fail;
 ...
 */
struct svalue *
living_parse(obvec, wvec, cix_in, fail)
    struct vector *obvec;
    struct vector *wvec;
    int *cix_in;
    int *fail;
 ...
 */
struct svalue *
single_parse(obvec, wvec, cix_in, fail)
    struct vector *obvec;
    struct vector *wvec;
    int *cix_in;
    int *fail;
 ...
 */
struct svalue *
prepos_parse(wvec, cix_in, fail, prepos)
    struct vector *wvec;
    int *cix_in;
    int *fail;
 ...
 */
int 
match_object(obix, wvec, cix_in, plur)
    int obix;
    struct vector *wvec;
    int *cix_in;
    int *plur;
 ...
 */
int 
check_adjectiv(obix, wvec, from, to)
    int obix;
    struct vector *wvec;
    int from;
    int to;
