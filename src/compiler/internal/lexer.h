...
int yylex(union YYSTYPE* yylval_param, struct YYLTYPE* yylloc_param,
          void* yyscanner);             // generated by Flex (lexer.autogen.cc)
...
int lpc_lex_resolve_identifier(union YYSTYPE* yylval_param, struct YYLTYPE* yylloc_param,
                               void* yyscanner);  // called from lexer.l's identifier rule
...
int parseHeredoc(const char* terminator, int is_array, union YYSTYPE* yylval_param,
                 ...
                 void* yyscanner);  // heredoc body reader (lexer_utils.cc)
...
int lpc_lex_start_heredoc(union YYSTYPE* yylval_param, struct YYLTYPE* yylloc_param,
                          void* yyscanner);
int parseMainEof(union YYSTYPE* yylval_param,
                 void* yyscanner);                     // called from lexer.l's <<EOF>> rule
