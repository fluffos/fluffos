...
#define ESCAPE_CHARACTERS	CONFIG_STR(__ESCAPE_CHARACTERS__)
...
#define EVALUATOR_STACK_SIZE	CONFIG_INT(__EVALUATOR_STACK_SIZE__)
#define MAX_LOCAL_VARIABLES	CONFIG_INT(__MAX_LOCAL_VARIABLES__)
#define MAX_CALL_DEPTH		CONFIG_INT(__MAX_CALL_DEPTH__)
#define LIVING_HASH_TABLE_SIZE	CONFIG_INT(__LIVING_HASH_TABLE_SIZE__)
#define MAX_SAVE_SVALUE_DEPTH	CONFIG_INT(__MAX_SAVE_SVALUE_DEPTH__)
#define PULSE_INTERVAL		CONFIG_INT(__PULSE_INTERVAL__)
#define ADDR_SERVER_RECONNECT	CONFIG_INT(__ADDR_SERVER_RECONNECT__)
