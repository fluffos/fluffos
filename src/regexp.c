...
STATIC void regerror P1(const char *, s) {
    switch (regexp_user) {
    case ED_REGEXP:
 ...
 * Forwards.
 */
STATIC int regtry PROT((regexp *, const char *));
 ...
 */
int regexec P2(register regexp *, prog, register const char *, string)
{
 ...
 */
static int regtry P2(regexp *, prog, const char *, string)
{
    register int i;
