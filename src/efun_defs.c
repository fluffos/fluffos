...
{"angle",F_ANGLE,0,0,2,2,TYPE_REAL,T_ARRAY|T_ARRAY,T_ARRAY|T_ARRAY,T_ANY,T_ANY,275,DEFAULT_NONE},
...
{"async_db_exec",F_ASYNC_DB_EXEC,0,0,3,3,TYPE_NOVALUE,T_NUMBER,T_STRING,T_FUNCTION,T_ANY,371,DEFAULT_NONE},
{"async_getdir",F_ASYNC_GETDIR,0,0,2,2,TYPE_NOVALUE,T_STRING,T_FUNCTION,T_ANY,T_ANY,373,DEFAULT_NONE},
{"async_read",F_ASYNC_READ,0,0,2,2,TYPE_NOVALUE,T_STRING,T_FUNCTION,T_ANY,T_ANY,373,DEFAULT_NONE},
{"async_write",F_ASYNC_WRITE,0,0,4,4,TYPE_NOVALUE,T_STRING,T_STRING,T_NUMBER,T_FUNCTION,377,DEFAULT_NONE},
...
{"base_name",F_BASE_NAME,0,0,1,1,TYPE_STRING,T_STRING|T_OBJECT,T_ANY,T_ANY,T_ANY,323,DEFAULT_THIS_OBJECT},
...
{"db_connect",F_DB_CONNECT,0,0,2,4,TYPE_NUMBER,T_STRING,T_STRING,T_STRING,T_NUMBER,261,DEFAULT_NONE},
...
{"distance",F_DISTANCE,0,0,2,2,TYPE_REAL,T_ARRAY|T_ARRAY,T_ARRAY|T_ARRAY,T_ANY,T_ANY,275,DEFAULT_NONE},
{"domain_stats",F_DOMAIN_STATS,0,0,0,1,TYPE_MAPPING,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
{"dotprod",F_DOTPROD,0,0,2,2,TYPE_REAL,T_ARRAY|T_ARRAY,T_ARRAY|T_ARRAY,T_ANY,T_ANY,278,DEFAULT_NONE},
{"dump_file_descriptors",F_DUMP_FILE_DESCRIPTORS,0,0,0,0,TYPE_STRING,T_ANY,T_ANY,T_ANY,T_ANY,0,DEFAULT_NONE},
{"dump_prog",F_DUMP_PROG,0,0,1,-1,TYPE_NOVALUE,T_OBJECT,T_ANY,T_ANY,T_ANY,284,DEFAULT_NONE},
{"dumpallhb",F_DUMPALLHB,0,0,0,1,TYPE_NOVALUE,T_STRING,T_ANY,T_ANY,T_ANY,20,DEFAULT_NONE},
...
{"event",F_EVENT,0,0,2,-1,TYPE_NOVALUE,T_OBJECT|T_ARRAY,T_STRING,T_ANY,T_ANY,317,DEFAULT_NONE},
...
{"external_start",F_EXTERNAL_START,0,0,4,5,TYPE_NUMBER,T_NUMBER,T_STRING|T_ARRAY,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,287,DEFAULT_NONE},
...
{"geteuid",F_GETEUID,0,0,1,1,TYPE_STRING,T_FUNCTION|T_OBJECT,T_ANY,T_ANY,T_ANY,258,DEFAULT_THIS_OBJECT},
...
{"ltrim",F_LTRIM,0,0,1,2,TYPE_STRING,T_ANY,T_STRING,T_ANY,T_ANY,254,DEFAULT_NONE},
{"m_delete",F_MAP_DELETE | F_ALIAS_FLAG,0,0,2,2,TYPE_MAPPING,T_MAPPING,T_ANY,T_ANY,T_ANY,143,DEFAULT_NONE},
{"m_indices",F_KEYS | F_ALIAS_FLAG,0,0,1,1,TYPE_MOD_ARRAY|TYPE_ANY,T_MAPPING,T_ANY,T_ANY,T_ANY,141,DEFAULT_NONE},
{"m_values",F_VALUES | F_ALIAS_FLAG,0,0,1,1,TYPE_MOD_ARRAY|TYPE_ANY,T_MAPPING,T_ANY,T_ANY,T_ANY,141,DEFAULT_NONE},
...
{"map_delete",F_MAP_DELETE,0,0,2,2,TYPE_MAPPING,T_MAPPING,T_ANY,T_ANY,T_ANY,143,DEFAULT_NONE},
...
{"norm",F_NORM,0,0,1,1,TYPE_REAL,T_ARRAY|T_ARRAY,T_ANY,T_ANY,T_ANY,275,DEFAULT_NONE},
...
{"objects_hb",F_OBJECTS_HB,0,0,0,1,TYPE_MOD_ARRAY|TYPE_OBJECT,T_STRING|T_FUNCTION,T_ANY,T_ANY,T_ANY,33,DEFAULT_NONE},
...
{"pow",F_POW,0,0,2,2,TYPE_REAL,T_REAL|T_NUMBER,T_REAL|T_NUMBER,T_ANY,T_ANY,269,DEFAULT_NONE},
...
{"replaceable",F_REPLACEABLE,0,0,1,2,TYPE_NUMBER,T_OBJECT,T_ARRAY,T_ANY,T_ANY,309,DEFAULT_NONE},
...
{"roll",F_ROLL,0,0,2,2,TYPE_NUMBER,T_NUMBER,T_NUMBER,T_ANY,T_ANY,49,DEFAULT_NONE},
{"round",F_ROUND,0,0,1,1,TYPE_REAL,T_REAL,T_ANY,T_ANY,T_ANY,77,DEFAULT_NONE},
{"rtrim",F_RTRIM,0,0,1,2,TYPE_STRING,T_ANY,T_STRING,T_ANY,T_ANY,254,DEFAULT_NONE},
...
{"socket_accept",F_SOCKET_ACCEPT,0,0,3,3,TYPE_NUMBER,T_NUMBER,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,T_ANY,326,DEFAULT_NONE},
{"socket_acquire",F_SOCKET_ACQUIRE,0,0,4,4,TYPE_NUMBER,T_NUMBER,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,357,DEFAULT_NONE},
{"socket_address",F_SOCKET_ADDRESS,0,0,2,2,TYPE_STRING,T_NUMBER|T_OBJECT,T_NUMBER,T_ANY,T_ANY,368,0},
...
{"socket_connect",F_SOCKET_CONNECT,0,0,4,4,TYPE_NUMBER,T_NUMBER,T_STRING,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,334,DEFAULT_NONE},
{"socket_create",F_SOCKET_CREATE,0,0,2,3,TYPE_NUMBER,T_NUMBER,T_STRING|T_FUNCTION,T_STRING|T_FUNCTION,T_ANY,326,DEFAULT_NONE},
...
{"socket_release",F_SOCKET_RELEASE,0,0,3,3,TYPE_NUMBER,T_NUMBER,T_OBJECT,T_STRING|T_FUNCTION,T_ANY,350,DEFAULT_NONE},
{"socket_status",F_SOCKET_STATUS,0,0,0,1,TYPE_MOD_ARRAY|TYPE_ANY,T_NUMBER,T_ANY,T_ANY,T_ANY,18,DEFAULT_NONE},
{"socket_write",F_SOCKET_WRITE,0,0,2,3,TYPE_NUMBER,T_NUMBER,T_ANY,T_STRING,T_ANY,344,DEFAULT_NONE},
...
{"store_variable",F_STORE_VARIABLE,0,0,2,2,TYPE_NOVALUE,T_STRING,T_ANY,T_ANY,T_ANY,313,DEFAULT_NONE},
...
{"strstr",F_STRSRCH | F_ALIAS_FLAG,0,0,3,3,TYPE_NUMBER,T_STRING,T_STRING|T_NUMBER,T_NUMBER,T_ANY,111,0},
...
{"terminal_colour",F_TERMINAL_COLOUR,0,0,2,4,TYPE_STRING,T_STRING,T_MAPPING,T_NUMBER,T_NUMBER,301,DEFAULT_NONE},
...
{"trim",F_TRIM,0,0,1,2,TYPE_STRING,T_ANY,T_STRING,T_ANY,T_ANY,254,DEFAULT_NONE},
