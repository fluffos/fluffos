...
int save_object(object_t *, const std::string, int);
int save_object_str(object_t *, int, std::string, int);
int restore_object(object_t *, const std::string, int);
void restore_variable(svalue_t *, std::string);
