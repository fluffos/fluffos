 ...
 * _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _
 *
 *  dprint flag added by Joel York (aka Shadowhawk) yorkjoe@elof.iit.edu
 */
...
#define MAXLINE	1500 /* max number of chars per line */
...
#define PDELFLG_MASK	0x0400
#define P_PDELFLG	( P_FLAGS & PDELFLG_MASK )
...
struct ed_buffer {
	...
	int	flags;		/* Contains all flags and indent level */
#if 0
...
struct tbl {
	...
	"dprint",	~FALSE,		PDELFLG_MASK,
	"nodprint",	~PDELFLG_MASK,	FALSE,
	0
};
    ...
    char *buff2;
{
    ...
    for (i = 0; i < (indent_level + temp_indent) * 3; i++)
        buff[i]=SP;
...
dprint     will print current line after deleting line(s)\n\
\n\
