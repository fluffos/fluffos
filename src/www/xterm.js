    ...
    var e = {
            ...
            let _ = t.AccessibilityManager = class extends h.Disposable {
                ...
                _renderRows(e, t) {
                    ...
                    for (let r = e; r <= t; r++) {
                        ...
                        n && (0 === e.length ? n.innerText = " " : n.textContent = e,
        ...
        3236: (e, t, i) => {
            ...
            class P extends y.CoreTerminal {
                ...
                constructor(e={}) {
                    ...
                    this.register((0,
                    w.forwardEvent)(this._inputHandler.onCursorMove, this._onCursorMove)),
                    this.register((0,
                    w.forwardEvent)(this._inputHandler.onTitleChange, this._onTitleChange)),
                    this.register((0,
                    w.forwardEvent)(this._inputHandler.onA11yChar, this._onA11yCharEmitter)),
                    this.register((0,
                    w.forwardEvent)(this._inputHandler.onA11yTab, this._onA11yTabEmitter)),
                ...
                open(e) {
                    ...
                    this._coreBrowserService = this._instantiationService.createInstance(v.CoreBrowserService, this.textarea, null !== (t = this._document.defaultView) && void 0 !== t ? t : window),
                    ...
                    this._selectionService = this.register(this._instantiationService.createInstance(m.SelectionService, this.element, this.screenElement, this.linkifier2)),
                ...
                bindMouse() {
                    ...
                    this.register(this.coreMouseService.onProtocolChange((e => {
                        ...
                        s.wheel = null),
                        2 & e ? s.mouseup || (t.addEventListener("mouseup", n.mouseup),
                        s.mouseup = n.mouseup) : (this._document.removeEventListener("mouseup", s.mouseup),
                ...
                scrollLines(e, t, i=0) {
                    ...
                    this.refresh(0, this.rows - 1)) : null === (s = this.viewport) || void 0 === s || s.scrollLines(e)
                }
                paste(e) {
                    (0,
            ...
            let C = 1
              , b = t.DomRenderer = class extends _.Disposable {
                ...
                _injectCss(e) {
                    ...
                    t += `${this._terminalSelector} .${v} .xterm-dim { color: ${l.color.multiplyOpacity(e.foreground, .5).css};}`,
                    ...
                    for (const [i,s] of e.ansi.entries())
                        t += `${this._terminalSelector} .${p}${i} { color: ${s.css}; }${this._terminalSelector} .${p}${i}.xterm-dim { color: ${l.color.multiplyOpacity(s, .5).css}; }${this._terminalSelector} .${g}${i} { background-color: ${s.css}; }`;
                    t += `${this._terminalSelector} .${p}${a.INVERTED_DEFAULT_COLOR} { color: ${l.color.opaque(e.background).css}; }${this._terminalSelector} .${p}${a.INVERTED_DEFAULT_COLOR}.xterm-dim { color: ${l.color.multiplyOpacity(l.color.opaque(e.background), .5).css}; }${this._terminalSelector} .${g}${a.INVERTED_DEFAULT_COLOR} { background-color: ${e.foreground.css}; }`,
        ...
        2550: (e, t) => {
            ...
            t.WidthCache = class {
                ...
                // 获取统一的中文字符宽度
                _getChineseCharWidth(e) {
                    if (e=='：' || e=='、' || e=='，' || e=='【' || e=='】' || e=='，' || e=='，') {   
                       this._chineseCharWidth = this._measure('中', 0);
                       return this._chineseCharWidth;
                    }
                    return 0;
                }
                get(e, t, i) {
                    ...
                    if (this._getChineseCharWidth(e)) {
                        return this._getChineseCharWidth(e);
                    }
        ...
        428: function(e, t, i) {
            ...
            class c {
                ...
                measure() {
                    ...
                    return 0 !== e.width && 0 !== e.height && (this._result.width = e.width / 32,
        ...
        3230: function(e, t, i) {
            ...
            let u = t.RenderService = class extends l.Disposable {
                ...
                constructor(e, t, i, s, r, h, _, u) {
                    ...
                    this.register(h.buffers.onBufferActivate(( () => {
                        var e;
                    ...
                    this.register(i.onMultipleOptionChange(["cursorBlink", "cursorStyle"], ( () => this.refreshRows(h.buffer.y, h.buffer.y, !0)))),
                    this.register((0,
                    n.addDisposableDomListener)(_.window, "resize", ( () => this.handleDevicePixelRatioChange()))),
                ...
                clearTextureAtlas() {
                    var e, t;
                    this._renderer.value && (null === (t = (e = this._renderer.value).clearTextureAtlas) || void 0 === t || t.call(e),
                    this._fullRefresh())
                }
                handleDevicePixelRatioChange() {
                    this._charSizeService.measure(),
        ...
        8055: (e, t, i) => {
            ...
            function(e) {
                ...
                e.ensureContrastRatio = function(e, t, i) {
                    ...
                    if (s)
                        return _.toColor(s >> 24 & 255, s >> 16 & 255, s >> 8 & 255)
                }
                ,
                e.opaque = function(e) {
        ...
        5435: function(e, t, i) {
            ...
            class E extends h.Disposable {
                ...
                constructor(e, t, i, s, r, h, _, f, v=new a.EscapeSequenceParser) {
                    ...
                    this._parser.registerOscHandler(0, new p.OscHandler((e => (this.setTitle(e),
                    this.setIconName(e),
                    !0)))),
                ...
                selectCharset(e) {
                    ...
                    !0) : ("/" === e[0] || this._charsetService.setgCharset(S[e[0]], o.CHARSETS[e[1]] || o.DEFAULT_CHARSET),
                    !0)
                }
                index() {
                    return this._restrictCursor(),
        ...
        8437: (e, t, i) => {
            ...
            class h {
                ...
                addCodepointToCell(e, t) {
                    ...
                    o.stringFromCodePoint)(t) : (2097151 & i ? (this._combined[e] = (0,
                    o.stringFromCodePoint)(2097151 & i) + (0,
                ...
                insertCells(e, t, i, n) {
                    if ((e %= this.length) && 2 === this.getWidth(e - 1) && this.setCellFromCodePoint(e - 1, 0, 1, (null == n ? void 0 : n.fg) || 0, (null == n ? void 0 : n.bg) || 0, (null == n ? void 0 : n.extended) || new s.ExtendedAttrs),
                    t < this.length - e) {
                ...
                deleteCells(e, t, i, n) {
                    ...
                    t < this.length - e) {
                        ...
                        for (let t = e; t < this.length; ++t)
                            this.setCell(t, i);
                    e && 2 === this.getWidth(e - 1) && this.setCellFromCodePoint(e - 1, 0, 1, (null == n ? void 0 : n.fg) || 0, (null == n ? void 0 : n.bg) || 0, (null == n ? void 0 : n.extended) || new s.ExtendedAttrs),
                    0 !== this.getWidth(e) || this.hasContent(e) || this.setCellFromCodePoint(e, 0, 1, (null == n ? void 0 : n.fg) || 0, (null == n ? void 0 : n.bg) || 0, (null == n ? void 0 : n.extended) || new s.ExtendedAttrs)
                }
                replaceCells(e, t, i, r, n=!1) {
                    if (n)
                        for (e && 2 === this.getWidth(e - 1) && !this.isProtected(e - 1) && this.setCellFromCodePoint(e - 1, 0, 1, (null == r ? void 0 : r.fg) || 0, (null == r ? void 0 : r.bg) || 0, (null == r ? void 0 : r.extended) || new s.ExtendedAttrs),
                        t < this.length && 2 === this.getWidth(t - 1) && !this.isProtected(t) && this.setCellFromCodePoint(t, 0, 1, (null == r ? void 0 : r.fg) || 0, (null == r ? void 0 : r.bg) || 0, (null == r ? void 0 : r.extended) || new s.ExtendedAttrs); e < t && e < this.length; )
                            this.isProtected(e) || this.setCell(e, i),
                            e++;
                    else
                        for (e && 2 === this.getWidth(e - 1) && this.setCellFromCodePoint(e - 1, 0, 1, (null == r ? void 0 : r.fg) || 0, (null == r ? void 0 : r.bg) || 0, (null == r ? void 0 : r.extended) || new s.ExtendedAttrs),
                        t < this.length && 2 === this.getWidth(t - 1) && this.setCellFromCodePoint(t, 0, 1, (null == r ? void 0 : r.fg) || 0, (null == r ? void 0 : r.bg) || 0, (null == r ? void 0 : r.extended) || new s.ExtendedAttrs); e < t && e < this.length; )
                            this.setCell(e++, i)
                }
                resize(e, t) {
                    if (e === this.length)
                ...
                translateToString(e=!1, t=0, i=this.length) {
                    ...
                    for (; t < i; ) {
                        const e = this._data[3 * t + 0]
                          , i = 2097151 & e;
                        s += 2097152 & e ? this._combined[t] : i ? (0,
