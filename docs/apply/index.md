...
<h2 class="border-bottom py-3 text-uppercase">
  {% octicon bookmark height:16 %} <a class='text-secondary' name="master" href="#master">master</a>
</h2>
...
<h2 class="border-bottom py-3 text-uppercase">
  {% octicon bookmark height:16 %} <a class='text-secondary' name="object" href="#object">object</a>
</h2>
