...
- `sidebars.generated.json` — generated by `gen_sidebar.py` from the reference trees (`efun/`, `apply/`, `stdlib/`, `concepts/`, `driver/`, `cli/`, `zh-CN/`) plus `sidebar_meta.json` (curated labels, descriptions, ordering). **Do not hand-edit.**
