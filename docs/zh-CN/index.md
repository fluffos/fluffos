...
<h2 class="border-bottom py-3 text-uppercase">
  {% octicon bookmark height:16 %} <a class='text-secondary' name="apply" href="#apply">apply</a>
</h2>
...
<h2 class="border-bottom py-3 text-uppercase">
  {% octicon bookmark height:16 %} <a class='text-secondary' name="build" href="#build">build</a>
</h2>
...
<h2 class="border-bottom py-3 text-uppercase">
  {% octicon bookmark height:16 %} <a class='text-secondary' name="efun" href="#efun">efun</a>
</h2>
